...
puts "========================================="
puts "	| afficher la taille de journaliste |" 
puts "========================================="
puts journaliste.length()

puts "============================================="
puts "	| Trouver des chiffres dans journaliste |" 
puts "============================================="
trier = Proc.new { |x| /\d/.match(x)}
puts journaliste.select(&trier)

puts "====================================="
puts "	| Trouver aude dans journaliste |" 
puts "===================================="
trier = Proc.new { |x| /aude/.match(x.downcase)}
puts journaliste.select(&trier).length

puts "====================================="
puts "	| Trouver Majuscule dans journaliste |" 
puts "===================================="
trier = Proc.new { |x| /[A-Z]/.match(x)}
puts journaliste.select(&trier).length

puts "=================================================================="
puts "	| Trouver mot qui commence par un majuscule dans journaliste |" 
puts "=================================================================="
trier = Proc.new { |x| /@[A-Z]/.match(x)}
puts journaliste.select(&trier).length

puts "====================================="
puts "	| Trouver un '_' dans journaliste |" 
puts "===================================="
trier = Proc.new { |x| /_/.match(x)}
puts journaliste.select(&trier).length

puts "====================================="
puts "	| Trier les handles dans journaliste |" 
puts "===================================="
puts journaliste.sort_by{|x| x.downcase}
